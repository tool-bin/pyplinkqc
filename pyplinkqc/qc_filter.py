...
def run_plink(bfile: str, *flags: str, make_bed: bool=True, plink_path: str="./plink"):
    ...
    *flags: str
    ...
    plink_path = config['PATHS']['plink_path'].strip('""')
    # plinkoutput = config['PATHS']['plinkoutput'].strip('""')
    # plinkerror = config['PATHS']['plinkerror'].strip('""')
