...
def check_snp_missingness(bfile: str, miss_out: str="plink", bfile_out: str="sample_missingness_filtered", snp_missingness_cutoff: float=0.2):
...
def check_sex_discrepancy(bfile: str="sample_missingness_filtered", sexcheck_out: str="plink.sexcheck", bfile_out: str="sex_discrepancy_filtered"):
...
def check_heterozygosity_rate(bfile: str="sex_discrepancy_filtered", snp_file: str="independent_snps", ld_out: str="ld_check", window: int=50, shift: int=5, correlation_threshold: float=0.2, correlation_method: str="pairwise", bfile_out: str="heterozygosity_filtered"):
...
def check_cryptic_relatedness(bfile: str="heterozygosity_filtered", snp_file: str="independent_snps", threshold: float=0.2, bfile_out: str="relatedness_filtered"):
...
def samples_failed_gen_report(bfile: str, write: bool=True, snp_missingness_cutoff: float=0.2, imiss_file: str="plink.imiss", lmiss_file: str="plink.lmiss", sexcheck_file: str="plink.sexcheck", ibd_threshold: float=0.2, ibd_file: str="pihat_min0.2.genome", figures_list: list=figures):
